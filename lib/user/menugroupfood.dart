...
class MenuGroupFood extends StatefulWidget {
  final GroupFoodModel groupFoodModel;
  final UserModel userModel;
  MenuGroupFood({Key key, this.userModel, this.groupFoodModel})
      : super(key: key);
  @override
  _MenuGroupFoodState createState() => _MenuGroupFoodState();
}

class _MenuGroupFoodState extends State<MenuGroupFood> {
  UserModel userModel;
  ...
  Future<Null> readFoodMenu() async {
    ...
    String url =
        '${MyConstant().domain}/mlao/getFoodwhereIdGrAndSh.php?isAdd=true&idGrp=$idGrp';
